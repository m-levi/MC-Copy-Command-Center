...
export const CreateModeSchema = z.object({
  ...
  enabled_tools: z.record(z.string(), z.unknown()).optional(),
  primary_artifact_types: z.array(z.string().min(1)).optional(),
  is_agent_enabled: z.boolean().optional(),
  agent_type: z.enum(['orchestrator', 'specialist', 'hybrid']).optional(),
  can_invoke_agents: z.array(z.string().min(1)).optional(),
  ...
  agent_behavior: z.object({
    ...
    announce_agent_switch: z.boolean().optional(),
    chain_limit: z.number().int().min(1).max(10).optional(),
  }).optional(),
