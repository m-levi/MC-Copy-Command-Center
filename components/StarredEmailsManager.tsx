...
interface StarredEmailsManagerProps {
  ...
  /** When true, renders without modal wrapper for inline use */
  inlineMode?: boolean;
}
...
export default function StarredEmailsManager({
  ...
  const content = (
    <>
      {/* Info Banner - only in inline mode */}
      {inlineMode && (
        <div className="bg-blue-50 dark:bg-blue-950/20 border-b border-blue-200 dark:border-blue-800 px-6 py-3 rounded-t-xl">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-blue-900 dark:text-blue-100">
              ...
              <p className="text-blue-700 dark:text-blue-200">
                When you star an email, it's added to your brand's knowledge base. The AI automatically uses these examples to learn your preferred style, tone, and structure.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Content */}
      <div className={`flex-1 overflow-hidden flex ${inlineMode ? 'min-h-[400px]' : ''}`}>
        {/* Email List */}
        <div className={`${inlineMode ? 'w-1/2' : 'w-2/5'} border-r border-gray-200 dark:border-gray-700 overflow-y-auto p-4`}>
          {loading ? (
      ...
      {/* Footer - with tip in inline mode */}
      {inlineMode && (
        <div className="bg-gray-50 dark:bg-gray-800/50 border-t border-gray-200 dark:border-gray-700 px-6 py-3 rounded-b-xl">
